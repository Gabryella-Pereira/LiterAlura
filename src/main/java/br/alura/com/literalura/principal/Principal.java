...
import br.alura.com.literalura.dto.BuscaDTO;
...
import br.alura.com.literalura.service.ConsumoApi;
import br.alura.com.literalura.service.ConverteDados;
...
public class Principal {
    ...
    public Principal(BookRepository livroRepository, AutorRepository autorRepository) {
    ...
    private void buscarLivroPorTitulo() {
        ...
        try {
            ...
            var resultados = conversor.obterDados(json, BuscaDTO.class);
